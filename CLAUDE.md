...
## Project Summary
An interaction React-Vite web app that provides improved visability of team skillsets, capacity and project demands for such. The app is fed new projects by end users, where PMO/Resource Managers analyse demand on resource against capacity/existing commitments before approving.
...
## Rules
- Use DESIGN.md for UI/UX styles and guidelines.
- Refer to AppRequirements.md for the requirements of this application.
